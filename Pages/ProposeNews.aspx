<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProposeNews.aspx.cs" Inherits="engine_stiri_1.Pages.AddNews" %>
...
<br />
 <table>
  ...
  <asp:Button ID="ButtonSend" runat="server" Text="Send" onclick="ButtonSend_Click" />
    ...
    <br />
    <br />
    <asp:Label ID="Label1" runat="server" Text="Trebuie sa fiti logat pentru a putea propune o stire."
