<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Tech.aspx.cs" Inherits="engine_stiri_1.NewsCategories.Tech" %>
...
<asp:DropDownList   ID="DropDownList1" AutoPostBack="true" runat="server" Height="25px"  
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [news] WHERE ([category] = 'tech')">
