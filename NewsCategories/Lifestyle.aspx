<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Lifestyle.aspx.cs" Inherits="engine_stiri_1.NewsCategories.Lifestyle" %>
...
<br />
   <asp:DropDownList   ID="DropDownList1" AutoPostBack="true" runat="server" Height="25px"  
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [news] WHERE ([category] = 'lifestyle')">
    </asp:SqlDataSource>
</asp:Content>
